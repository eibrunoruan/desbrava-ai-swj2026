  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-indigo-950 to-slate-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 right-1/3 w-96 h-96 bg-violet-500/10 rounded-full blur-3xl" />
      </div>
      ...
      <header className="relative z-10 py-6 px-4">
        <div className="max-w-2xl mx-auto flex items-center gap-3">
          <motion.div
            ...
            className="w-10 h-10 rounded-xl bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-purple-500/25"
          >
